    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-navy border-t border-navy-foreground/10 sticky top-16 z-40">
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="hidden lg:block pt-4 pb-2 space-y-3">
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3">
              <div className="flex items-center gap-2">
                <p className="text-xs font-semibold text-navy-foreground/50 uppercase tracking-wider whitespace-nowrap">Type:</p>
            ...
            <div className="flex items-start gap-2">
              <p className="text-xs font-semibold text-navy-foreground/50 uppercase tracking-wider whitespace-nowrap pt-1">Subspecialty:</p>
              <div className="flex flex-wrap gap-1.5">
          ...
          <Collapsible open={mobileFiltersOpen} onOpenChange={setMobileFiltersOpen}>
            <CollapsibleContent className="lg:hidden pt-4 pb-2 space-y-4 animate-accordion-down">
              <div>
